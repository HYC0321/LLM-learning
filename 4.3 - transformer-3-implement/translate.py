...
MODEL_PATH = "models/best_model_80.pt"
...
def translate_sentence(sentence: str, model, src_vocab, tgt_vocab, device, max_len=50, decode_strategy='greedy'):
    ...
    return " ".join(result_tokens).replace("<sos>", "").replace("<eos>", "").strip()
...
if __name__ == '__main__':
    ...
    # 打印一些翻译样本进行直观感受
    evaluate_and_show_examples(model, test_data, src_vocab, tgt_vocab, DEVICE, num_examples=5)
